    ...
    try {
        ...
        async function verifyInProfile() {
            const selectors = [
                ...
                '//android.widget.TextView[@text="cuerposespeciales" and @resource-id="com.instagram.android:id/row_profile_header_username"]'
            ];
        ...
        try {
            ...
            const profileContainers = await driver.$$('//*[contains(@resource-id, "row_search") or contains(@resource-id, "search_result")]//android.widget.TextView[@text="cuerposespeciales"]');
...
async function markStoriesAsViewedOnDevice(udid, driver) {
    ...
    try {
        ...
        const windowSize = await driver.getWindowSize();
        // Borde derecho: usar 90-95% del ancho para asegurar que está en la zona de "siguiente story"
